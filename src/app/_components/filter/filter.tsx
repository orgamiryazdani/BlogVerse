...
export const Filter: React.FC = () => {
    ...
    return (
        <>
            ...
            <div
                className={`md:w-[30%] w-full md:h-[490px] ${showFilter ? 'h-[75%]' : 'h-0'} transition-all duration-300 ease-in-out fixed left-0 right-0 bottom-0 md:rounded-md rounded-t-lg md:bg-gray-700/50 bg-gray-700 md:mt-5 px-[7px] pt-[5px] md:sticky md:top-4`}
            >
                <Search />
            </div>
        </>
